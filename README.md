...
>
> 🌐 **在线体验**: [https://vlogify.onrender.com](https://vlogify.onrender.com)
>
> [![Deploy to Render](https://render.com/images/deploy-to-render-button.svg)](https://render.com/deploy?repo=https://github.com/vvlife/vlogify)
...
3. 服务名保持 `vlogify` 或自定义
4. 在环境变量中填入 `AGNES_API_KEY`（Agnes AI 的 API Key）
5. 点击「Create Web Service」
6. 等待 Docker 构建完成（约 3-5 分钟）
7. 部署完成后访问 `https://vlogify.onrender.com`

> Render 免费版会在 15 分钟无活动后休眠，首次访问需等待约 30 秒冷启动。
