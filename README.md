...
以下是用 Vlogify 生成的三条示范 Vlog，分别使用不同风格和素材：

### 1. 漫展奇遇记（活力节奏风格）

![漫展奇遇记](docs/demos/demo1_energetic_thumb.jpg)

- **素材**：3 段手机拍摄的漫展视频（cosplay、活动现场、舞台表演）
- **风格**：⚡ 活力节奏
- **AI 标题**：夏日次元破壁！漫展Cosplay高能实录
- **AI 摘要**：记录一场充满热血与创意的夏日漫展，用镜头捕捉Coser们的惊艳瞬间与青春活力。
- **成片**：720×1280 竖屏 | 49.5s | 12MB
- **观看**：[demo1_energetic.mp4](docs/demos/demo1_energetic.mp4)

### 2. 夏日远行（旅行游记风格）

![夏日远行](docs/demos/demo2_travel_thumb.jpg)

- **素材**：3 段风景视频（田野、山村、天灯）
- **风格**：✈️ 旅行游记
- **AI 标题**：我的Vlog
- **AI 摘要**：精彩瞬间合集
- **成片**：720×1280 竖屏 | 25.2s | 5.8MB
- **观看**：[demo2_travel.mp4](docs/demos/demo2_travel.mp4)

### 3. AI时代（纪录片风格）

![AI时代](docs/demos/demo3_documentary_thumb.jpg)

- **素材**：3 段科技活动视频（AI展览、颁奖仪式、室内演讲）
- **风格**：📹 纪录片
- **AI 标题**：未来已来：AI科技展探索日志
- **AI 摘要**：以纪实视角记录AI展览中的互动体验与前沿技术，展现科技与人文交融的未来图景。
- **成片**：720×1280 竖屏 | 77.7s | 8.0MB
- **AI 封面**：![AI封面](docs/demos/demo3_cover.png)
- **观看**：[demo3_documentary.mp4](docs/demos/demo3_documentary.mp4)
